...
const NFT_STORAGE_KEY = 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdWIiOiJkaWQ6ZXRocjoweDgxOGE3MWEyOThmMmMzN0YwMmQyMjVDZjhiYTU5OENiQUU0Zjk1NjQiLCJpc3MiOiJuZnQtc3RvcmFnZSIsImlhdCI6MTcxMDY3NzI0NTkyMSwibmFtZSI6Imdsb2JhbC1saWJyYXJ5In0._hbFQLXQfjIOYLeXnyyIbqiCF5kIK85p25BpQ3tUB-k'
...
export class NftStoragePublishRepository implements PublishRepository {
    async publish(story: Story) {
        ...
        return new Publication(JSON.stringify(result));
    }
}